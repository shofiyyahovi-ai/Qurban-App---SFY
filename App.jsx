...
const SEED_HEWAN = [
  {
    id: "S001",
    jenis: "Sapi",
    nama: "Sapi Gemuk Al-Barakah",
    berat: "380",
    asal: "Pak Haji Suryanto - Boyolali",
    harga: "18500000",
    kapasitas: "7",
    status: "Selesai",
    statusHistory: [
      { dari: "Menunggu", ke: "Disembelih", oleh: "USR_admin", waktu: "2026-06-14T06:30:00.000Z" },
      { dari: "Disembelih", ke: "Dikuliti", oleh: "USR_admin", waktu: "2026-06-14T07:15:00.000Z" },
      { dari: "Dikuliti", ke: "Selesai", oleh: "USR_admin", waktu: "2026-06-14T08:00:00.000Z" },
    ],
  ...
  },
  {
    id: "S002",
    jenis: "Sapi",
    nama: "Sapi Jantan An-Nuur",
    berat: "420",
    asal: "CV. Ternak Subur - Klaten",
    harga: "21000000",
    kapasitas: "7",
    status: "Dikuliti",
    statusHistory: [
      { dari: "Menunggu", ke: "Disembelih", oleh: "USR_admin", waktu: "2026-06-14T06:00:00.000Z" },
      { dari: "Disembelih", ke: "Dikuliti", oleh: "USR_admin", waktu: "2026-06-14T07:00:00.000Z" },
    ],
  ...
  },
  {
    id: "S003",
    jenis: "Sapi",
    nama: "Sapi Limousin Berkah",
    berat: "450",
    asal: "Pak Burhan - Magelang",
    harga: "23000000",
    kapasitas: "7",
    status: "Disembelih",
    statusHistory: [
      { dari: "Menunggu", ke: "Disembelih", oleh: "USR_admin", waktu: "2026-06-14T06:45:00.000Z" },
    ],
    createdAt: "2026-06-01T07:20:00.000Z",
    createdBy: "USR_admin",
    updatedAt: "2026-06-14T06:45:00.000Z",
    updatedBy: "USR_admin",
  },
  {
    id: "S004",
    jenis: "Sapi",
    nama: "Sapi Simental Ar-Rahmah",
    berat: "395",
    asal: "UD. Kandang Sejahtera - Wonosobo",
    harga: "19800000",
    kapasitas: "7",
    status: "Menunggu",
    statusHistory: [],
  ...
  },
  {
    id: "S005",
    jenis: "Sapi",
    nama: "Sapi PO Idul Adha",
    berat: "360",
    asal: "Koperasi Peternak Maju - Purwokerto",
    harga: "17200000",
    kapasitas: "7",
    status: "Menunggu",
    statusHistory: [],
  ...
  },
  {
    id: "K001",
    jenis: "Kambing",
    nama: "Kambing Ettawa Barokah",
    berat: "42",
    asal: "Pak Ahmad - Kaligesing Purworejo",
    harga: "3200000",
    kapasitas: "1",
    status: "Selesai",
    statusHistory: [
      { dari: "Menunggu", ke: "Disembelih", oleh: "USR_admin", waktu: "2026-06-14T07:30:00.000Z" },
      { dari: "Disembelih", ke: "Dikuliti", oleh: "USR_admin", waktu: "2026-06-14T08:00:00.000Z" },
      { dari: "Dikuliti", ke: "Selesai", oleh: "USR_admin", waktu: "2026-06-14T08:30:00.000Z" },
    ],
  ...
  },
  {
    id: "K002",
    jenis: "Kambing",
    nama: "Kambing Jawa Hidayah",
    berat: "35",
    asal: "Pak Slamet - Bantul",
    harga: "2700000",
    kapasitas: "1",
    status: "Disembelih",
    statusHistory: [
      { dari: "Menunggu", ke: "Disembelih", oleh: "USR_admin", waktu: "2026-06-14T08:15:00.000Z" },
    ],
    createdAt: "2026-06-01T08:10:00.000Z",
    createdBy: "USR_admin",
    updatedAt: "2026-06-14T08:15:00.000Z",
    updatedBy: "USR_admin",
  },
  {
    id: "K003",
    jenis: "Kambing",
    nama: "Kambing PE Sunnah",
    berat: "38",
    asal: "Ibu Hj. Romlah - Wonosari",
    harga: "2900000",
    kapasitas: "1",
    status: "Menunggu",
    statusHistory: [],
  ...
  },
  {
    id: "K004",
    jenis: "Kambing",
    nama: "Kambing Boer Taqwa",
    berat: "45",
    asal: "CV. Kambing Unggul - Sleman",
    harga: "3500000",
    kapasitas: "1",
    status: "Menunggu",
    statusHistory: [],
  ...
  },
  {
    ...
    status: "Selesai",
    statusHistory: [
      { dari: "Menunggu", ke: "Disembelih", oleh: "USR_admin", waktu: "2026-06-14T07:00:00.000Z" },
      { dari: "Disembelih", ke: "Dikuliti", oleh: "USR_admin", waktu: "2026-06-14T07:30:00.000Z" },
      { dari: "Dikuliti", ke: "Selesai", oleh: "USR_admin", waktu: "2026-06-14T08:00:00.000Z" },
    ],
  ...
  },
  {
    id: "D002",
    jenis: "Domba",
    nama: "Domba Garut Ikhlas",
    berat: "28",
    asal: "UD. Peternakan Amanah - Garut",
    harga: "2200000",
    kapasitas: "1",
    status: "Menunggu",
    statusHistory: [],
  ...
  },
  {
    id: "D003",
    jenis: "Domba",
    nama: "Domba Lokal Sabar",
    berat: "25",
    asal: "Pak Wahyu - Bandung",
    harga: "1900000",
    kapasitas: "1",
    status: "Menunggu",
    statusHistory: [],
...
const SEED_MUDHOHI = [
  { id: "M001", nama: "H. Bambang Suryanto", hp: "081234567801", alamat: "RT 01/RW 01 - Gg. Mangga", jenisHewan: "Sapi", hewanId: "S001", bayar: "Lunas", nominal: "2642857", cicilanLog: [], waLog: [], createdAt: "2026-06-02T08:00:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-02T08:00:00.000Z", updatedBy: "USR_admin" },
  { id: "M002", nama: "Ibu Siti Khodijah", hp: "081234567802", alamat: "RT 01/RW 02 - Perum Griya Asri", jenisHewan: "Sapi", hewanId: "S001", bayar: "Lunas", nominal: "2642857", cicilanLog: [], waLog: [], createdAt: "2026-06-02T08:10:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-02T08:10:00.000Z", updatedBy: "USR_admin" },
  { id: "M003", nama: "Pak Drs. Wahyu Hidayat", hp: "081234567803", alamat: "RT 02/RW 01 - Jl. Kenanga No. 5", jenisHewan: "Sapi", hewanId: "S001", bayar: "Lunas", nominal: "2642857", cicilanLog: [], waLog: [], createdAt: "2026-06-02T08:20:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-02T08:20:00.000Z", updatedBy: "USR_admin" },
  { id: "M004", nama: "Budi Santoso, S.Kom", hp: "081234567804", alamat: "RT 02/RW 02 - Komplek Melati", jenisHewan: "Sapi", hewanId: "S001", bayar: "Cicilan", nominal: "1500000", cicilanLog: [], waLog: [], createdAt: "2026-06-02T08:30:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-02T08:30:00.000Z", updatedBy: "USR_admin" },
  { id: "M005", nama: "Hj. Fatimah Az-Zahra", hp: "081234567805", alamat: "RT 03/RW 01 - Jl. Mawar Blok B", jenisHewan: "Sapi", hewanId: "S001", bayar: "Lunas", nominal: "2642857", cicilanLog: [], waLog: [], createdAt: "2026-06-03T09:00:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-03T09:00:00.000Z", updatedBy: "USR_admin" },
  { id: "M006", nama: "Ahmad Fauzan Ridho", hp: "081234567806", alamat: "RT 03/RW 02 - Gg. Flamboyan", jenisHewan: "Sapi", hewanId: "S001", bayar: "Belum Lunas", nominal: "1000000", cicilanLog: [], waLog: [], createdAt: "2026-06-03T09:10:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-03T09:10:00.000Z", updatedBy: "USR_admin" },
  { id: "M007", nama: "Dra. Nurul Hidayati", hp: "081234567807", alamat: "RT 04/RW 01 - Perum Villa Indah", jenisHewan: "Sapi", hewanId: "S001", bayar: "Lunas", nominal: "2642857", cicilanLog: [], waLog: [], createdAt: "2026-06-03T09:20:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-03T09:20:00.000Z", updatedBy: "USR_admin" },
  { id: "M008", nama: "Ir. Agus Prasetyo", hp: "081234567808", alamat: "RT 04/RW 02 - Jl. Anggrek No. 12", jenisHewan: "Sapi", hewanId: "S002", bayar: "Lunas", nominal: "3000000", cicilanLog: [], waLog: [], createdAt: "2026-06-03T10:00:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-03T10:00:00.000Z", updatedBy: "USR_admin" },
  { id: "M009", nama: "Sri Rahayu Wulandari", hp: "081234567809", alamat: "RT 05/RW 01 - Griya Permata", jenisHewan: "Sapi", hewanId: "S002", bayar: "Lunas", nominal: "3000000", cicilanLog: [], waLog: [], createdAt: "2026-06-03T10:10:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-03T10:10:00.000Z", updatedBy: "USR_admin" },
  { id: "M010", nama: "M. Rizky Firmansyah", hp: "081234567810", alamat: "RT 05/RW 02 - Jl. Dahlia 7", jenisHewan: "Sapi", hewanId: "S002", bayar: "Belum Lunas", nominal: "1500000", cicilanLog: [], waLog: [], createdAt: "2026-06-04T08:00:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-04T08:00:00.000Z", updatedBy: "USR_admin" },
  { id: "M011", nama: "Drs. H. Supardi MM", hp: "081234567811", alamat: "RT 06/RW 01 - Jl. Cempaka No. 3", jenisHewan: "Sapi", hewanId: "S002", bayar: "Lunas", nominal: "3000000", cicilanLog: [], waLog: [], createdAt: "2026-06-04T08:10:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-04T08:10:00.000Z", updatedBy: "USR_admin" },
  { id: "M012", nama: "Endang Kusuma Dewi", hp: "081234567812", alamat: "RT 06/RW 02 - Blok C No. 8", jenisHewan: "Sapi", hewanId: "S002", bayar: "Cicilan", nominal: "2000000", cicilanLog: [], waLog: [], createdAt: "2026-06-04T08:20:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-04T08:20:00.000Z", updatedBy: "USR_admin" },
  { id: "M013", nama: "Yusuf Al-Hakim", hp: "081234567813", alamat: "RT 07/RW 01 - Gg. Melati No. 2", jenisHewan: "Sapi", hewanId: "S002", bayar: "Lunas", nominal: "3000000", cicilanLog: [], waLog: [], createdAt: "2026-06-04T09:00:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-04T09:00:00.000Z", updatedBy: "USR_admin" },
  { id: "M014", nama: "Raden Ayu Kartika Sari", hp: "081234567814", alamat: "RT 07/RW 02 - Jl. Teratai No. 4", jenisHewan: "Sapi", hewanId: "S003", bayar: "Lunas", nominal: "3285714", cicilanLog: [], waLog: [], createdAt: "2026-06-05T07:00:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-05T07:00:00.000Z", updatedBy: "USR_admin" },
  { id: "M015", nama: "Kholid Abdul Aziz", hp: "081234567815", alamat: "RT 08/RW 01 - Perum Graha Mukti", jenisHewan: "Sapi", hewanId: "S003", bayar: "Belum Lunas", nominal: "2000000", cicilanLog: [], waLog: [], createdAt: "2026-06-05T07:10:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-05T07:10:00.000Z", updatedBy: "USR_admin" },
  { id: "M016", nama: "Hj. Mariyam Susanti", hp: "081234567816", alamat: "RT 08/RW 02 - Jl. Wijaya Kusuma", jenisHewan: "Sapi", hewanId: "S003", bayar: "Lunas", nominal: "3285714", cicilanLog: [], waLog: [], createdAt: "2026-06-05T07:20:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-05T07:20:00.000Z", updatedBy: "USR_admin" },
  { id: "M017", nama: "Dr. Teguh Prabowo SpPD", hp: "081234567817", alamat: "RT 09/RW 01 - Jl. Imam Bonjol 15", jenisHewan: "Kambing", hewanId: "K001", bayar: "Lunas", nominal: "3200000", cicilanLog: [], waLog: [], createdAt: "2026-06-05T08:00:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-05T08:00:00.000Z", updatedBy: "USR_admin" },
  { id: "M018", nama: "Nur Aini Rahmawati", hp: "081234567818", alamat: "RT 09/RW 02 - Gg. Bougenvil", jenisHewan: "Kambing", hewanId: "K002", bayar: "Lunas", nominal: "2700000", cicilanLog: [], waLog: [], createdAt: "2026-06-05T08:10:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-05T08:10:00.000Z", updatedBy: "USR_admin" },
  { id: "M019", nama: "Saiful Bahri, SE", hp: "081234567819", alamat: "RT 10/RW 01 - Komplek Permata Hijau", jenisHewan: "Kambing", hewanId: "K003", bayar: "Belum Lunas", nominal: "1000000", cicilanLog: [], waLog: [], createdAt: "2026-06-06T09:00:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-06T09:00:00.000Z", updatedBy: "USR_admin" },
  { id: "M020", nama: "Ust. Abdurrahman Salim", hp: "081234567820", alamat: "RT 10/RW 02 - Jl. Raya Barat No. 21", jenisHewan: "Kambing", hewanId: "K004", bayar: "Lunas", nominal: "3500000", cicilanLog: [], waLog: [], createdAt: "2026-06-06T09:10:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-06T09:10:00.000Z", updatedBy: "USR_admin" },
  { id: "M021", nama: "Poppy Indriani Putri", hp: "081234567821", alamat: "RT 11/RW 01 - Taman Bunga Blok D", jenisHewan: "Domba", hewanId: "D001", bayar: "Lunas", nominal: "2500000", cicilanLog: [], waLog: [], createdAt: "2026-06-06T10:00:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-06T10:00:00.000Z", updatedBy: "USR_admin" },
  { id: "M022", nama: "Taufik Hidayatullah", hp: "081234567822", alamat: "RT 11/RW 02 - Jl. Nusa Indah No. 7", jenisHewan: "Domba", hewanId: "D002", bayar: "Cicilan", nominal: "1200000", cicilanLog: [], waLog: [], createdAt: "2026-06-07T08:00:00.000Z", createdBy: "USR_admin", updatedAt: "2026-06-07T08:00:00.000Z", updatedBy: "USR_admin" },
];
const SEED_MUSTAHIQ = [
  { id: "P001", nama: "Ibu Siti Aminah", rt: "RT 01", alamat: "Jl. Melati No. 3", anggota: "4", sesi: "Sesi 1 - Pagi", sudahAmbil: true, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: "USR_admin", ditandaiWaktu: SEED_TIMESTAMP, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P002", nama: "Pak Ahmad Fauzi", rt: "RT 02", alamat: "Gg. Mawar No. 7", anggota: "3", sesi: "Sesi 1 - Pagi", sudahAmbil: true, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: "USR_admin", ditandaiWaktu: SEED_TIMESTAMP, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P003", nama: "Ibu Khadijah Wulandari", rt: "RT 01", alamat: "Jl. Kenanga No. 12", anggota: "5", sesi: "Sesi 1 - Pagi", sudahAmbil: false, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: null, ditandaiWaktu: null, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P004", nama: "Pak Budi Santoso", rt: "RT 03", alamat: "Jl. Dahlia No. 5", anggota: "2", sesi: "Sesi 1 - Pagi", sudahAmbil: false, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: null, ditandaiWaktu: null, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P005", nama: "Ibu Fatimah Zahra", rt: "RT 02", alamat: "Gg. Anggrek No. 2", anggota: "6", sesi: "Sesi 2 - Siang", sudahAmbil: true, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: "USR_admin", ditandaiWaktu: SEED_TIMESTAMP, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P006", nama: "Pak Umar Hakim", rt: "RT 04", alamat: "Jl. Flamboyan No. 9", anggota: "4", sesi: "Sesi 2 - Siang", sudahAmbil: true, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: "USR_admin", ditandaiWaktu: SEED_TIMESTAMP, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P007", nama: "Ibu Rahmawati", rt: "RT 03", alamat: "Gg. Bougenvil No. 4", anggota: "3", sesi: "Sesi 2 - Siang", sudahAmbil: false, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: null, ditandaiWaktu: null, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P008", nama: "Pak Yusuf Hidayat", rt: "RT 05", alamat: "Jl. Seruni No. 18", anggota: "5", sesi: "Sesi 2 - Siang", sudahAmbil: false, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: null, ditandaiWaktu: null, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P009", nama: "Ibu Nurhayati", rt: "RT 04", alamat: "Jl. Cempaka No. 6", anggota: "4", sesi: "Sesi 2 - Siang", sudahAmbil: false, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: null, ditandaiWaktu: null, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P010", nama: "Pak Hendra Gunawan", rt: "RT 05", alamat: "Gg. Tulip No. 11", anggota: "2", sesi: "Sesi 3 - Sore", sudahAmbil: true, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: "USR_admin", ditandaiWaktu: SEED_TIMESTAMP, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P011", nama: "Ibu Dewi Lestari", rt: "RT 01", alamat: "Jl. Mawar No. 15", anggota: "3", sesi: "Sesi 3 - Sore", sudahAmbil: false, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: null, ditandaiWaktu: null, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P012", nama: "Pak Irfan Maulana", rt: "RT 02", alamat: "Gg. Lavender No. 3", anggota: "4", sesi: "Sesi 3 - Sore", sudahAmbil: false, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: null, ditandaiWaktu: null, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P013", nama: "Ibu Supriyati", rt: "RT 03", alamat: "Jl. Teratai No. 8", anggota: "5", sesi: "Sesi 3 - Sore", sudahAmbil: false, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: null, ditandaiWaktu: null, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P014", nama: "Pak Ridwan Kamil", rt: "RT 04", alamat: "Jl. Wijaya No. 20", anggota: "6", sesi: "Sesi 1 - Pagi", sudahAmbil: true, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: "USR_admin", ditandaiWaktu: SEED_TIMESTAMP, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P015", nama: "Ibu Marlina Sari", rt: "RT 05", alamat: "Gg. Kamboja No. 1", anggota: "3", sesi: "Sesi 1 - Pagi", sudahAmbil: false, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: null, ditandaiWaktu: null, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P016", nama: "Pak Saiful Bahri", rt: "RT 01", alamat: "Jl. Nusa Indah No. 4", anggota: "4", sesi: "Sesi 2 - Siang", sudahAmbil: true, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: "USR_admin", ditandaiWaktu: SEED_TIMESTAMP, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P017", nama: "Ibu Halimah Tusyadiyah", rt: "RT 02", alamat: "Jl. Asoka No. 16", anggota: "7", sesi: "Sesi 2 - Siang", sudahAmbil: false, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: null, ditandaiWaktu: null, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P018", nama: "Pak Zainudin", rt: "RT 03", alamat: "Gg. Kemuning No. 9", anggota: "2", sesi: "Sesi 3 - Sore", sudahAmbil: true, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: "USR_admin", ditandaiWaktu: SEED_TIMESTAMP, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P019", nama: "Ibu Romlah", rt: "RT 04", alamat: "Jl. Sakura No. 2", anggota: "5", sesi: "Sesi 3 - Sore", sudahAmbil: false, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: null, ditandaiWaktu: null, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
  { id: "P020", nama: "Pak Musthofa Kamal", rt: "RT 05", alamat: "Gg. Kantil No. 14", anggota: "4", sesi: "Sesi 1 - Pagi", sudahAmbil: false, createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM", updatedAt: SEED_TIMESTAMP, updatedBy: "SYSTEM", ambilLog: { ditandaiOleh: null, ditandaiWaktu: null, dibatalkanOleh: null, dibatalkanWaktu: null, alasanBatal: null } },
];

const SEED_SESI = [
  { id: "SE001", nama: "Sesi 1 - Pagi", jam: "07:00 - 09:00", kuota: "50", createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM" },
  { id: "SE002", nama: "Sesi 2 - Siang", jam: "10:00 - 12:00", kuota: "50", createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM" },
  { id: "SE003", nama: "Sesi 3 - Sore", jam: "13:00 - 15:00", kuota: "40", createdAt: SEED_TIMESTAMP, createdBy: "SYSTEM" },
];
